        ...
        <div class="buttons mt-5 flex justify-between fixed w-[560px]">
            ...
            <dialog id="my_modal_1" class="modal">
                <form method="dialog" class="modal-box">
                    ...
                    <p class="py-4 indent-5 pt-0 pb-3 font-bold">Наші контакти: </p>
                    <p class="py-4 indent-5 pt-0 pb-3">lighthouseplatform@mail.mail </p>
                    <p class="py-4 indent-5 pt-0 pb-3">+380841564984 </p>
